angular.module('directive.g+signin', ["ngRoute","pubnub.angular.service","ngCookies"]).
  directive('googlePlusSignin', ['$window', '$rootScope','$location', function ($window, $rootScope,$location) {
      ...
      return {
          ...
          link: function (scope, element, attrs, ctrl, linker) {
              ...
              function onSignIn(authResult) {
            	  if(logout){
            		  document.getElementById('user-photo').src = "../img/user.jpg";
        	          document.getElementById('user-photoSB').src = "../img/user.jpg";
